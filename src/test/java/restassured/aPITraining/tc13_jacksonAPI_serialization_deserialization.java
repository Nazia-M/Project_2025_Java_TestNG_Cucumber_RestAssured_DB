...
public class tc13_jacksonAPI_serialization_deserialization {
    ...
    public void jackson_API_serialization_deserialization() throws JsonProcessingException {
        ...
        // Serialization :  Java objects -> JSON string(Payload) : writeValueAsString
...
//            3. Deserialization  - This is used real time
        ...
        tc12_Response_POJO_Deserialization_1 response_des = om.readValue(response.asString(), tc12_Response_POJO_Deserialization_1.class);
